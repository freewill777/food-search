...
function MobileNav() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Link, {
    ...
    animate: "visible",
    exit: "hidden",
    className: "bg-white fixed inset-y-0 right-0 z-20 flex w-9/12 flex-col bg-dark-100 px-12 transition-colors dark:bg-dark-700 md:hidden h-full flex-wrap items-start justify-center gap-y-14"
...
//# sourceMappingURL=/build/root-FSL6YE3M.js.map
