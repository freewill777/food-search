...
function createMotionComponent(_a) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return React3.createElement(VisualElementHandler, { visualElement: context.visualElement, props: __assign(__assign({}, config), props) }, features, React3.createElement(MotionContext.Provider, { value: context }, useRender(Component, props, projectionId, useMotionRef(visualState, context.visualElement, externalRef), visualState, config.isStatic, context.visualElement)));
  }
...
var visualElement = function(_a) {
  ...
  return function(_a2, options) {
    var parent = _a2.parent, props = _a2.props, presenceId2 = _a2.presenceId, blockInitialAnimation = _a2.blockInitialAnimation, visualState = _a2.visualState, shouldReduceMotion = _a2.shouldReduceMotion;
    if (options === void 0) {
      options = {};
    }
    var isMounted = false;
...
function useForceUpdate() {
  var isUnmountingRef = (0, import_react30.useRef)(false);
  var _a = __read((0, import_react30.useState)(0), 2), forcedRenderCount = _a[0], setForcedRenderCount = _a[1];
  useUnmountEffect(function() {
    return isUnmountingRef.current = true;
  });
  var forceRender = (0, import_react30.useCallback)(function() {
    !isUnmountingRef.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  var deferredForceRender = (0, import_react30.useCallback)(function() {
...
var PresenceChild = function(_a) {
  ...
  var context = (0, import_react31.useMemo)(function() {
    return {
      id: id2,
      initial,
      isPresent,
  ...
  (0, import_react31.useMemo)(function() {
...
var AnimatePresence = function(_a) {
  ...
  var forceRenderLayoutGroup = (0, import_react32.useContext)(LayoutGroupContext).forceRender;
  if (forceRenderLayoutGroup)
    forceRender = forceRenderLayoutGroup;
  var isInitialRender = (0, import_react32.useRef)(true);
  var isMounted = (0, import_react32.useRef)(true);
  ...
  var presentChildren = (0, import_react32.useRef)(filteredChildren);
  var allChildren = (0, import_react32.useRef)(/* @__PURE__ */ new Map()).current;
  var exiting = (0, import_react32.useRef)(/* @__PURE__ */ new Set()).current;
...
var AnimatedText = ({
  ...
  const renderWords = (0, import_react33.useMemo)(() => words.map((word, index2) => /* @__PURE__ */ React.createElement("span", {
    key: index2,
...
var AnimatedLetters = ({
  ...
  }, words.map((_, index2) => /* @__PURE__ */ React.createElement("span", {
    key: index2,
    className: "inline-block whitespace-nowrap",
    style: { marginTop: "0.35em" }
  }, [...words[index2]].flat().map((letter, letterIndex) => /* @__PURE__ */ React.createElement("span", {
    key: letterIndex,
    className: "inline-block overflow-hidden"
  }, /* @__PURE__ */ React.createElement(motion.span, {
...
***************************************************************************** */
//# sourceMappingURL=/build/_shared/chunk-ZDQ75NIL.js.map
