...
function MobileNav() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(motion.header, {
    ...
    initial: "hidden",
    animate: "visible",
    className: "container fixed top-8 right-4 z-30 text-dark-100 mix-blend-difference hover:opacity-60 dark:text-white md:hidden \n    bg-white\n    bg-dark-50 dark:bg-dark-850 \n    dark:text-dark-50 text-dark-600"
...
//# sourceMappingURL=/build/root-6B3NAZLW.js.map
