...
var Hero = () => {
  return /* @__PURE__ */ React.createElement("header", {
    ...
    className: "z-[-10] absolute scale-[0.6] -bottom-[38rem] right-[50%] \n      translate-x-[50%] md:translate-x-0 md:scale-[0.8] md:bottom-auto md:top-52 \n      md:-right-40 lg:-right-36 lg:top-16 xl:-top-24 xl:-right-20 2xl:-right-16 lg:scale-100"
  }, "sal"), /* @__PURE__ */ React.createElement(motion.section, {
    variants: {
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-RANXVEWJ.js.map
