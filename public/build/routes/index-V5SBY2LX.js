import {
  require_react_dom
} from "/build/_shared/chunk-FWVALISK.js";
import {
  GenIcon,
  HTMLElementType,
...
} from "/build/_shared/chunk-AYEPFEVH.js";
import {
  AnimatedLetters,
  AnimatedText
...
import {
  ...
  useLoaderData,
  useTransition
} from "/build/_shared/chunk-7RECILBC.js";
import {
  React,
  __commonJS,
  __esm,
...
var jsonStringifyReplacer = (_3, value) => {
...
function ClickAwayListener(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(React3.Fragment, {
    children: /* @__PURE__ */ React3.cloneElement(children, childrenProps)
  });
}
...
var Portal = /* @__PURE__ */ React4.forwardRef(function Portal2(props, ref) {
  const {
    children,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(/* @__PURE__ */ React4.isValidElement(children) ? children.ref : null, ref);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (/* @__PURE__ */ React4.isValidElement(children)) {
      const newProps = {
        ref: handleRef
      };
      return /* @__PURE__ */ React4.cloneElement(children, newProps);
    }
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(React4.Fragment, {
      children
    });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(React4.Fragment, {
...
var PopperTooltip = /* @__PURE__ */ React5.forwardRef(function PopperTooltip2(props, ref) {
  var _ref;
  const {
    anchorEl,
    children,
...
var PopperUnstyled = /* @__PURE__ */ React5.forwardRef(function PopperUnstyled2(props, ref) {
  const {
    anchorEl,
    children,
...
function useSnackbar(parameters) {
  ...
  const timerAutoHide = React6.useRef();
  React6.useEffect(() => {
    if (!open) {
      return void 0;
    }
  ...
  const handleResume = React6.useCallback(() => {
...
var Popper = /* @__PURE__ */ React8.forwardRef(function Popper2(inProps, ref) {
  var _slots$root;
...
var ListSubheader = /* @__PURE__ */ React9.forwardRef(function ListSubheader2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListSubheader"
  });
...
var IconButton = /* @__PURE__ */ React17.forwardRef(function IconButton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiIconButton"
  });
...
true ? IconButton.propTypes = {
  children: chainPropTypes(import_prop_types13.default.node, (props) => {
    const found = React17.Children.toArray(props.children).some((child) => /* @__PURE__ */ React17.isValidElement(child) && child.props.onClick);
    if (found) {
...
var Chip = /* @__PURE__ */ React21.forwardRef(function Chip2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const ownerState = _extends({}, props, {
    ...
    size,
    color,
    iconColor: /* @__PURE__ */ React21.isValidElement(iconProp) ? iconProp.props.color || color : color,
    onDelete: !!onDelete,
    clickable,
    variant
  });
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && /* @__PURE__ */ React21.isValidElement(deleteIconProp) ? /* @__PURE__ */ React21.cloneElement(deleteIconProp, {
  ...
  let avatar = null;
  if (avatarProp && /* @__PURE__ */ React21.isValidElement(avatarProp)) {
    avatar = /* @__PURE__ */ React21.cloneElement(avatarProp, {
      className: clsx_m_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && /* @__PURE__ */ React21.isValidElement(iconProp)) {
    icon = /* @__PURE__ */ React21.cloneElement(iconProp, {
...
var Autocomplete = /* @__PURE__ */ React24.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Chip_default, _extends({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(React24.Fragment, {
...
var _t42;
var SIZE = 44;
var circularRotateKeyframe = (0, import_react.keyframes)(_t5 || (_t5 = _2`
  0% {
...
`));
var circularDashKeyframe = (0, import_react.keyframes)(_t22 || (_t22 = _2`
  0% {
...
var CircularProgressRoot = styled_default("span", {
  ...
  ownerState
}) => ownerState.variant === "indeterminate" && (0, import_react.css)(_t32 || (_t32 = _2`
...
var CircularProgressCircle = styled_default("circle", {
  ...
  ownerState
}) => ownerState.variant === "indeterminate" && !ownerState.disableShrink && (0, import_react.css)(_t42 || (_t42 = _2`
      animation: ${0} 1.4s ease-in-out infinite;
    `), circularDashKeyframe));
var CircularProgress = /* @__PURE__ */ React25.forwardRef(function CircularProgress2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiCircularProgress"
  });
...
true ? CircularProgress.propTypes = {
  ...
  disableShrink: chainPropTypes(import_prop_types17.default.bool, (props) => {
    if (props.disableShrink && props.variant && props.variant !== "indeterminate") {
      return new Error("MUI: You have provided the `disableShrink` prop with a variant other than `indeterminate`. This will have no effect.");
    }
    return null;
  }),
  size: import_prop_types17.default.oneOfType([import_prop_types17.default.number, import_prop_types17.default.string]),
  ...
  variant: import_prop_types17.default.oneOf(["determinate", "indeterminate"])
} : void 0;
...
var _excluded14 = ["action", "className", "message", "role"];
...
var SnackbarContent = /* @__PURE__ */ React27.forwardRef(function SnackbarContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSnackbarContent"
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(SnackbarContentRoot, _extends({
    role,
    square: true,
    elevation: 6,
    className: clsx_m_default(classes.root, className),
    ...
    children: [/* @__PURE__ */ (0, import_jsx_runtime25.jsx)(SnackbarContentMessage, {
      className: classes.message,
      ownerState,
      children: message
    }), action ? /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(SnackbarContentAction, {
...
true ? SnackbarContent.propTypes = {
  ...
  message: import_prop_types19.default.node,
...
var _excluded15 = ["onEnter", "onExited"];
...
var Snackbar = /* @__PURE__ */ React28.forwardRef(function Snackbar2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSnackbar"
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(ClickAwayListener_default, _extends({
    onClickAway
  }, ClickAwayListenerProps, {
    children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(SnackbarRoot, _extends({}, rootProps, {
      children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(TransitionComponent, _extends({
        appear: true,
        in: open,
        ...
        children: children || /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(SnackbarContent_default, _extends({
          message,
          action
        }, ContentProps))
      }))
...
true ? Snackbar.propTypes = {
  ...
  anchorOrigin: import_prop_types20.default.shape({
    horizontal: import_prop_types20.default.oneOf(["center", "left", "right"]).isRequired,
  ...
  ClickAwayListenerProps: import_prop_types20.default.object,
  ContentProps: import_prop_types20.default.object,
  disableWindowBlurListener: import_prop_types20.default.bool,
  key: () => null,
  message: import_prop_types20.default.node,
...
var Input = (0, import_react10.forwardRef)(({ name, label, placeholder, required = false, onChange }, ref) => {
...
var Hero = () => {
  ...
  const [openSnackbar, setOpenSnackbar] = React29.useState(false);
  const [option, setOption] = React29.useState("");
  const [prompt, setPrompt] = React29.useState("");
  return /* @__PURE__ */ React29.createElement("header", {
  ...
  }, /* @__PURE__ */ React29.createElement(Snackbar_default, {
    open: openSnackbar,
    autoHideDuration: 2500,
    message: `${option} added to list!`,
    onClose: () => setOpenSnackbar(false)
  }), /* @__PURE__ */ React29.createElement(motion.section, {
    variants: {
  ...
  }, /* @__PURE__ */ React29.createElement(AnimatePresence, null, /* @__PURE__ */ React29.createElement("article", {
    className: "lg:max-w-[60%]"
  }, /* @__PURE__ */ React29.createElement(AnimatedLetters, {
    as: "h1",
  ...
  }), /* @__PURE__ */ React29.createElement(AnimatedText, {
    as: "h1",
  ...
  }, /* @__PURE__ */ React29.createElement(Autocomplete_default, {
    open,
    onChange: (_3, b) => {
      setOpen(!open);
    ...
    renderOption: (props, option2) => /* @__PURE__ */ React29.createElement("li", {
      ...props,
    ...
    options,
    renderInput: (params) => /* @__PURE__ */ React29.createElement("div", {
    ...
    style: { width: "100%" }
  })), /* @__PURE__ */ React29.createElement(MotionLinkButton, {
    to: "#",
    motionProps: {
      variants: {
        hidden: { opacity: 0, y: 50 },
    ...
    onClick: async () => {
      setLoading(true);
      await updatePrompt(() => setLoading(true), () => setLoading(false), setOptions, options, prompt, () => setOpen(!open));
      setLoading(false);
    }
  }, loading ? /* @__PURE__ */ React29.createElement("div", {
    style: { width: "100px", paddingInlineStart: "20px", paddingTop: "1px" }
  }, /* @__PURE__ */ React29.createElement(CircularProgress_default, {
    size: 22,
    style: { visibility: loading ? "visible" : "hidden", color: "#805b50" }
  })) : /* @__PURE__ */ React29.createElement("span", null, "Search"))))));
};
async function updatePrompt(setTrue, setFalse, setSearchResults, searchResults, prompt, openModal) {
  ...
  const names = json2.map((element) => element == null ? void 0 : element.description);
  openModal();
...
function Index() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Hero, null));
}
export {
  Index as default,
  meta
 ...
 */
//# sourceMappingURL=/build/routes/index-V5SBY2LX.js.map
