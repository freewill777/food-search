...
function qe(e2, t2, n2) {
  ...
  var C, I2 = new se(n2, g2, o2 ? e2.componentStyle : void 0), P2 = I2.isStatic && c2.length === 0, O = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      }(i3, r2, y2, true ? e4.warnTooManyClasses : void 0), w2 = n3, _3 = g3.$as || t4.$as || g3.as || t4.as || p2, N2 = ke(_3), A3 = g3 !== t4 ? v({}, t4, {}, g3) : t4, C2 = {};
      for (var I3 in A3)
        I3[0] !== "$" && I3 !== "as" && (I3 === "forwardedAs" ? C2.as = A3[I3] : (d3 ? d3(I3, import_is_prop_valid.default, _3) : !N2 || (0, import_is_prop_valid.default)(I3)) && (C2[I3] = A3[I3]));
      return t4.style && g3.style !== t4.style && (C2.style = v({}, t4.style, {}, g3.style)), C2.className = Array.prototype.concat(c3, h3, S3 !== h3 ? S3 : null, t4.className, g3.className).filter(Boolean).join(" "), C2.ref = w2, (0, import_react8.createElement)(_3, C2);
    }(C, e3, t3, P2);
  };
...
var SearchInput = styled_components_browser_esm_default.input`
  padding-right: 30px;
`;
var SearchIcon = styled_components_browser_esm_default(FaSearch)`
  position: absolute;
  top: 50%;
  right: 10px;
...
var Hero = () => {
  ...
  return /* @__PURE__ */ React22.createElement("header", {
    id: "intro",
    style: { height: "100vh" },
  ...
  }, /* @__PURE__ */ React22.createElement(motion.section, {
    variants: {
  ...
  }, /* @__PURE__ */ React22.createElement(AnimatePresence, null, /* @__PURE__ */ React22.createElement("article", {
    className: "lg:max-w-[60%]"
  }, /* @__PURE__ */ React22.createElement(AnimatedLetters, {
    as: "h1",
  ...
  }), /* @__PURE__ */ React22.createElement(AnimatedText, {
    as: "h1",
  ...
  }, /* @__PURE__ */ React22.createElement(Autocomplete_default, {
    open,
    onChange: (_3, b2) => {
      setOpen(!open);
      alert(b2);
    ...
    options,
    renderInput: (params) => /* @__PURE__ */ React22.createElement("div", {
  ...
  })), /* @__PURE__ */ React22.createElement(MotionLinkButton, {
    to: "#",
    motionProps: {
      variants: {
        hidden: { opacity: 0, y: 50 },
 ...
 */
//# sourceMappingURL=/build/routes/index-3RIC6BLO.js.map
