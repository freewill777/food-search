...
} from "/build/_shared/chunk-OH534DNL.js";
import {
  AnimatedLetters,
  AnimatedText,
  require_useMedia
...
// app/components/input.tsx
var Input = (0, import_react8.forwardRef)(({ name, label, placeholder, required = false, onChange }, ref) => {
...
var PopperTooltip = /* @__PURE__ */ React5.forwardRef(function PopperTooltip2(props, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Root, _extends({}, rootProps, {
...
var PopperUnstyled = /* @__PURE__ */ React5.forwardRef(function PopperUnstyled2(props, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Portal_default, {
    disablePortal,
    container,
    children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(PopperTooltip, _extends({
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Autocomplete = /* @__PURE__ */ React24.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(React24.Fragment, {
...
var CircularProgress = /* @__PURE__ */ React25.forwardRef(function CircularProgress2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(CircularProgressRoot, _extends({
    className: clsx_m_default(classes.root, className),
    style: _extends({
      width: size,
      height: size
...
var SnackbarContent = /* @__PURE__ */ React27.forwardRef(function SnackbarContent2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(SnackbarContentRoot, _extends({
    role,
    square: true,
    elevation: 6,
    className: clsx_m_default(classes.root, className),
    ...
    children: [/* @__PURE__ */ (0, import_jsx_runtime26.jsx)(SnackbarContentMessage, {
      className: classes.message,
      ownerState,
      children: message
    }), action ? /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(SnackbarContentAction, {
...
var Snackbar = /* @__PURE__ */ React28.forwardRef(function Snackbar2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(ClickAwayListener_default, _extends({
    onClickAway
  }, ClickAwayListenerProps, {
    children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(SnackbarRoot, _extends({}, rootProps, {
      children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(TransitionComponent, _extends({
        appear: true,
        in: open,
        ...
        children: children || /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(SnackbarContent_default, _extends({
          message,
          action
        }, ContentProps))
      }))
...
var Hero = () => {
  ...
  const [loading, setLoading] = React29.useState(true);
  ...
  return /* @__PURE__ */ React29.createElement("header", {
    ...
    onClick: async () => {
      setLoading(true);
      updatePrompt(() => setLoading(true), () => setLoading(false), setOptions, options, prompt);
      setLoading(false);
      setOpen(!open);
    }
  }, loading ? /* @__PURE__ */ React29.createElement(CircularProgress_default, {
    size: 25,
    sx: {
      position: "absolute",
      alignSelf: "self-end",
    ...
    style: { visibility: loading ? "visible" : "hidden" }
  }) : null, " Search               ", /* @__PURE__ */ React29.createElement(CircularProgress_default, {
    size: 30,
    style: { visibility: loading ? "visible" : "hidden" }
  }))))));
};
async function updatePrompt(setTrue, setFalse, setSearchResults, searchResults, prompt) {
 ...
 */
//# sourceMappingURL=/build/routes/index-2SYVX4OW.js.map
