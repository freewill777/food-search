...
var FlyContainer = () => {
  ...
  (0, import_react11.useEffect)(() => {
    ...
    const spawnInterval = setInterval(() => {
      const newShit = React.cloneElement(/* @__PURE__ */ React.createElement(FlyingShit_default, null), {
        style: {
          left: "0px",
          top: "0px",
      ...
      Boolean(container) && container.appendChild(newShit);
      setTimeout(() => {
 ...
 */
//# sourceMappingURL=/build/routes/index-M4SZ6ITN.js.map
