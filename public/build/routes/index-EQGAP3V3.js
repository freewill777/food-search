...
var require_arrayPush = __commonJS({
  "node_modules/lodash/_arrayPush.js"(exports, module) {
    ...
    function arrayPush(array, values3) {
      var index = -1, length = values3.length, offset2 = array.length;
      while (++index < length) {
  ...
  "node_modules/@sendgrid/helpers/classes/mail.js"(exports, module) {
    ...
    var Mail = class {
      ...
      setSubstitutionWrappers(substitutionWrappers) {
        let lengthCheck = (propertyName, value2) => {
      ...
      setDynamicTemplateData(dynamicTemplateData) {
        ...
        if (!this.hideWarnings) {
          Object.values(dynamicTemplateData).forEach((value2) => {
            if (/['"&]/.test(value2)) {
      ...
      setCategories(categories) {
        let allElementsAreStrings = (propertyName, value2) => {
      ...
      addHeader(key, value2) {
        if (this._checkProperty("key", key, [this._createTypeCheck("string")]) && this._checkProperty("value", value2, [this._createTypeCheck("string")])) {
          this.headers[key] = value2;
        }
      }
      ...
      _checkProperty(propertyName, value2, checks) {
        return !checks.some((e) => e(propertyName, value2));
      }
      _setProperty(propertyName, value2, propertyType) {
        let propertyChecksPassed = this._checkProperty(propertyName, value2, [this._checkUndefined, this._createTypeCheck(propertyType)]);
        if (propertyChecksPassed) {
          this[propertyName] = value2;
        }
        return propertyChecksPassed;
      }
      _checkUndefined(propertyName, value2) {
        return typeof value2 === "undefined";
      }
      _createTypeCheck(propertyType) {
        return (propertyName, value2) => {
          if (typeof value2 !== propertyType) {
      ...
      _setArrayProperty(propertyName, value2) {
        if (this._doArrayCheck(propertyName, value2)) {
          this[propertyName] = value2;
        }
      }
      _doArrayCheck(propertyName, value2) {
        return this._checkProperty(propertyName, value2, [this._checkUndefined, this._createCheckThatThrows(Array.isArray, "Array expected for`" + propertyName + "`")]);
      }
...
var require_client = __commonJS({
  "node_modules/@sendgrid/client/src/classes/client.js"(exports, module) {
    ...
    var Client = class {
      ...
      setDefaultHeader(key, value2) {
        if (key !== null && typeof key === "object") {
          Object.assign(this.defaultHeaders, key);
          return this;
        }
        this.defaultHeaders[key] = value2;
        return this;
      }
      setDefaultRequest(key, value2) {
        if (key !== null && typeof key === "object") {
          Object.assign(this.defaultRequest, key);
          return this;
        }
        this.defaultRequest[key] = value2;
        return this;
      }
      createHeaders(data) {
      ...
      function q(r2, a2) {
        while (_2())
          if (r2 + e.character === 47 + 10)
            ...
            break;
        return "/*" + L(a2, e.position - 1) + "*" + k(r2 === 47 ? r2 : _2());
      }
      function J(r2) {
        while (!D(F()))
          _2();
...
var require_emotion_cache_cjs_dev = __commonJS({
  "node_modules/@emotion/cache/dist/emotion-cache.cjs.dev.js"(exports) {
    ...
    function prefix2(value2, length) {
      switch (stylis.hash(value2, length)) {
        case 5103:
          return stylis.WEBKIT + "print-" + value2 + value2;
        case 5737:
        case 4201:
        case 3177:
        case 3433:
        ...
        case 5621:
        case 3829:
          return stylis.WEBKIT + value2 + value2;
        case 5349:
        case 4246:
        case 4810:
        case 6968:
        case 2756:
          return stylis.WEBKIT + value2 + stylis.MOZ + value2 + stylis.MS + value2 + value2;
        case 6828:
        case 4268:
          return stylis.WEBKIT + value2 + stylis.MS + value2 + value2;
        case 6165:
          return stylis.WEBKIT + value2 + stylis.MS + "flex-" + value2 + value2;
        case 5187:
          return stylis.WEBKIT + value2 + stylis.replace(value2, /(\w+).+(:[^]+)/, stylis.WEBKIT + "box-$1$2" + stylis.MS + "flex-$1$2") + value2;
        case 5443:
          return stylis.WEBKIT + value2 + stylis.MS + "flex-item-" + stylis.replace(value2, /flex-|-self/, "") + value2;
        case 4675:
          return stylis.WEBKIT + value2 + stylis.MS + "flex-line-pack" + stylis.replace(value2, /align-content|flex-|-self/, "") + value2;
        case 5548:
          return stylis.WEBKIT + value2 + stylis.MS + stylis.replace(value2, "shrink", "negative") + value2;
        case 5292:
          return stylis.WEBKIT + value2 + stylis.MS + stylis.replace(value2, "basis", "preferred-size") + value2;
        case 6060:
          return stylis.WEBKIT + "box-" + stylis.replace(value2, "-grow", "") + stylis.WEBKIT + value2 + stylis.MS + stylis.replace(value2, "grow", "positive") + value2;
        case 4554:
          return stylis.WEBKIT + stylis.replace(value2, /([^-])(transform)/g, "$1" + stylis.WEBKIT + "$2") + value2;
        case 6187:
          return stylis.replace(stylis.replace(stylis.replace(value2, /(zoom-|grab)/, stylis.WEBKIT + "$1"), /(image-set)/, stylis.WEBKIT + "$1"), value2, "") + value2;
        case 5495:
        case 3959:
          return stylis.replace(value2, /(image-set\([^]*)/, stylis.WEBKIT + "$1$`$1");
        case 4968:
          return stylis.replace(stylis.replace(value2, /(.+:)(flex-)?(.*)/, stylis.WEBKIT + "box-pack:$3" + stylis.MS + "flex-pack:$3"), /s.+-b[^;]+/, "justify") + stylis.WEBKIT + value2 + value2;
        case 4095:
        case 3583:
        case 4068:
        case 2532:
          return stylis.replace(value2, /(.+)-inline(.+)/, stylis.WEBKIT + "$1$2") + value2;
        case 8116:
        case 7059:
        case 5753:
        case 5535:
        ...
        case 5021:
        case 4765:
          if (stylis.strlen(value2) - 1 - length > 6)
            switch (stylis.charat(value2, length + 1)) {
              case 109:
                if (stylis.charat(value2, length + 4) !== 45)
                  break;
              case 102:
                return stylis.replace(value2, /(.+:)(.+)-([^]+)/, "$1" + stylis.WEBKIT + "$2-$3$1" + stylis.MOZ + (stylis.charat(value2, length + 3) == 108 ? "$3" : "$2-$3")) + value2;
              case 115:
                return ~stylis.indexof(value2, "stretch") ? prefix2(stylis.replace(value2, "stretch", "fill-available"), length) + value2 : value2;
            }
          break;
        case 4949:
          if (stylis.charat(value2, length + 1) !== 115)
            break;
        case 6444:
          switch (stylis.charat(value2, stylis.strlen(value2) - 3 - (~stylis.indexof(value2, "!important") && 10))) {
            case 107:
              return stylis.replace(value2, ":", ":" + stylis.WEBKIT) + value2;
            case 101:
              return stylis.replace(value2, /(.+:)([^;!]+)(;|!.+)?/, "$1" + stylis.WEBKIT + (stylis.charat(value2, 14) === 45 ? "inline-" : "") + "box$3$1" + stylis.WEBKIT + "$2$3$1" + stylis.MS + "$2box$3") + value2;
          }
          break;
        case 5936:
          switch (stylis.charat(value2, length + 11)) {
            case 114:
              return stylis.WEBKIT + value2 + stylis.MS + stylis.replace(value2, /[svh]\w+-[tblr]{2}/, "tb") + value2;
            case 108:
              return stylis.WEBKIT + value2 + stylis.MS + stylis.replace(value2, /[svh]\w+-[tblr]{2}/, "tb-rl") + value2;
            case 45:
              return stylis.WEBKIT + value2 + stylis.MS + stylis.replace(value2, /[svh]\w+-[tblr]{2}/, "lr") + value2;
          }
          return stylis.WEBKIT + value2 + stylis.MS + value2 + value2;
      }
      return value2;
      ...
      if (element.length > -1) {
        if (!element["return"])
          switch (element.type) {
            ...
            case stylis.RULESET:
              if (element.length)
                return stylis.combine(element.props, function(value2) {
                  switch (stylis.match(value2, /(::plac\w+|:read-\w+)/)) {
                    case ":read-only":
                    case ":read-write":
                      return stylis.serialize([stylis.copy(element, {
                        props: [stylis.replace(value2, /:(read-\w+)/, ":" + stylis.MOZ + "$1")]
                      })], callback);
                    case "::placeholder":
                      return stylis.serialize([stylis.copy(element, {
                        props: [stylis.replace(value2, /:(plac\w+)/, ":" + stylis.WEBKIT + "input-$1")]
                      }), stylis.copy(element, {
                        props: [stylis.replace(value2, /:(plac\w+)/, ":" + stylis.MOZ + "$1")]
                      }), stylis.copy(element, {
                        props: [stylis.replace(value2, /:(plac\w+)/, stylis.MS + "input-$1")]
                      })], callback);
                  }
                  return "";
                });
...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`;
    ...
    var processStyleValue = function processStyleValue2(key, value2) {
      switch (key) {
        ...
        case "animationName": {
          if (typeof value2 === "string") {
            return value2.replace(animationRegex, function(match, p1, p2) {
              cursor = {
                name: p1,
                styles: p2,
                next: cursor
...
var require_emotion_element_b63ca7c6_cjs_dev = __commonJS({
  "node_modules/@emotion/react/dist/emotion-element-b63ca7c6.cjs.dev.js"(exports) {
    ...
    var ThemeContext3 = /* @__PURE__ */ React33.createContext({});
    if (true) {
      ThemeContext3.displayName = "EmotionThemeContext";
    }
    var useTheme5 = function useTheme6() {
      return React33.useContext(ThemeContext3);
    };
    ...
    var ThemeProvider = function ThemeProvider2(props) {
      var theme = React33.useContext(ThemeContext3);
      if (props.theme !== theme) {
        theme = createCacheWithTheme(theme)(props.theme);
      }
      return /* @__PURE__ */ React33.createElement(ThemeContext3.Provider, {
        value: theme
      }, props.children);
    };
    function withTheme(Component) {
      ...
      var render = function render2(props, ref) {
        var theme = React33.useContext(ThemeContext3);
        return /* @__PURE__ */ React33.createElement(Component, _extends2({
          theme,
          ref
        }, props));
      };
    ...
    var Emotion = /* @__PURE__ */ exports.withEmotionCache(function(props, cache, ref) {
      ...
      var serialized = serialize.serializeStyles(registeredStyles, void 0, React33.useContext(ThemeContext3));
...
var require_emotion_react_cjs_dev = __commonJS({
  "node_modules/@emotion/react/dist/emotion-react.cjs.dev.js"(exports) {
    ...
    var Global = /* @__PURE__ */ emotionElement.withEmotionCache(function(props, cache) {
      ...
      var serialized = serialize.serializeStyles([styles], void 0, React33.useContext(emotionElement.ThemeContext));
...
var getCheckboxDefaultChecked = (value2, defaultValue) => {
  if (Array.isArray(defaultValue))
    return defaultValue.includes(value2);
...
var createGetInputProps = ({ clearError, validate, defaultValue, touched, setTouched, hasBeenSubmitted, validationBehavior, name }) => {
  ...
  return (props = {}) => {
    ...
    if (inputProps.type === "checkbox") {
      const value2 = (_a = props.value) !== null && _a !== void 0 ? _a : "on";
      inputProps.defaultChecked = getCheckboxDefaultChecked(value2, defaultValue);
    } else if (inputProps.type === "radio") {
      const value2 = (_b = props.value) !== null && _b !== void 0 ? _b : "on";
      inputProps.defaultChecked = defaultValue === value2;
    } else {
...
var MultiValueMap = class {
  constructor() {
    ...
    this.remove = (key, value2) => {
      ...
      const index = array.indexOf(value2);
      if (index !== -1)
...
var objectFromPathEntries = (entries) => {
  ...
  entries.forEach(([key, value2]) => map.add(key, value2));
  return [...map.entries()].reduce((acc, [key, value2]) => (0, import_set.default)(acc, key, value2.length === 1 ? value2[0] : value2), {});
};
...
function createValidator(validator3) {
  return {
    validate: (value2) => {
      const data = preprocessFormData(value2);
...
function withZod(zodSchema) {
  return createValidator({
    validate: (value2) => {
      const result = zodSchema.safeParse(value2);
      if (result.success)
...
var jsonStringifyReplacer = (_2, value2) => {
...
var ClassNameConfiguratorContext = /* @__PURE__ */ React9.createContext(defaultContextValue);
...
var Portal = /* @__PURE__ */ React10.forwardRef(function Portal2(props, ref) {
  const {
    children,
    container,
    disablePortal = false
  ...
  if (disablePortal) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(React10.Fragment, {
      children
    });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(React10.Fragment, {
...
var PopperTooltip = /* @__PURE__ */ React11.forwardRef(function PopperTooltip2(props, ref) {
  var _ref;
  const {
    anchorEl,
    children,
  ...
  const popperRef = React11.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React11.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React11.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React11.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React11.useState(resolveAnchorEl(anchorEl));
  React11.useEffect(() => {
...
var PopperUnstyled = /* @__PURE__ */ React11.forwardRef(function PopperUnstyled2(props, ref) {
  const {
    anchorEl,
    children,
  ...
  const fn2 = (props) => {
    ...
    const styleFromPropValue = (propValueFinal) => {
      ...
      if (propValueFinal === value2 && typeof propValueFinal === "string") {
        value2 = getStyleValue(themeMapping, transform, `${prop}${propValueFinal === "default" ? "" : capitalize(propValueFinal)}`, propValueFinal);
      }
    ...
    function traverse(sxInput) {
      ...
      Object.keys(sxObject).forEach((styleKey) => {
        ...
        if (value2 !== null && value2 !== void 0) {
          if (typeof value2 === "object") {
            if (config[styleKey]) {
              css2 = merge_default(css2, getThemeValue(styleKey, value2, theme, config));
            } else {
...
function createBreakpoints(breakpoints) {
  ...
  function up(key) {
    const value2 = typeof values3[key] === "number" ? values3[key] : key;
...
init_react();
function clamp(value2, min2 = 0, max2 = 1) {
  if (true) {
...
The following color spaces are supported: srgb, display-p3, a98-rgb, prophoto-rgb, rec-2020.` : formatMuiErrorMessage(10, colorSpace));
  ...
  values3 = values3.map((value2) => parseFloat(value2));
  return {
    type,
    values: values3,
    colorSpace
...
function createTransitions(inputTransitions) {
  ...
  const create = (props = ["all"], options = {}) => {
    ...
    if (true) {
      ...
      const isNumber = (value2) => !isNaN(parseFloat(value2));
...
var Popper = /* @__PURE__ */ React16.forwardRef(function Popper2(inProps, ref) {
  var _slots$root;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(PopperRoot, _extends({
...
var ListSubheader = /* @__PURE__ */ React17.forwardRef(function ListSubheader2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiListSubheader"
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ListSubheaderRoot, _extends({
    as: component,
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ import_react13.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ import_react13.default.createElement(Component, props, children));
  };
...
var DURATION = 550;
var DELAY_RIPPLE = 80;
var enterKeyframe = (0, import_react10.keyframes)(_t || (_t = _`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
...
`));
var exitKeyframe = (0, import_react10.keyframes)(_t2 || (_t2 = _`
  0% {
    opacity: 1;
  }
...
`));
var pulsateKeyframe = (0, import_react10.keyframes)(_t3 || (_t3 = _`
  0% {
    transform: scale(1);
  }
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(SvgIcon_default, _extends({
...
var Chip = /* @__PURE__ */ React28.forwardRef(function Chip2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const ownerState = _extends({}, props, {
    ...
    size,
    color: color2,
    iconColor: /* @__PURE__ */ React28.isValidElement(iconProp) ? iconProp.props.color || color2 : color2,
    onDelete: !!onDelete,
    clickable,
    variant
  });
...
var Autocomplete = /* @__PURE__ */ React31.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const {
    ...
    ChipProps,
    className,
    clearIcon = _ClearIcon || (_ClearIcon = /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Close_default, {
      fontSize: "small"
    })),
    clearOnBlur = !props.freeSolo,
    clearOnEscape = false,
    ...
    popupIcon = _ArrowDropDownIcon || (_ArrowDropDownIcon = /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(ArrowDropDown_default, {})),
    readOnly = false,
  ...
  if (multiple && value2.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value2.map((option, index) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Chip_default, _extends({
  ...
  if (limitTags > -1 && Array.isArray(startAdornment)) {
    ...
    if (!focused && more > 0) {
      ...
      startAdornment.push(/* @__PURE__ */ (0, import_jsx_runtime21.jsx)("span", {
        className: classes.tag,
        children: getLimitTagsText(more)
      }, startAdornment.length));
    }
  }
  const defaultRenderGroup = (params) => /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)("li", {
    children: [/* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AutocompleteGroupLabel, {
      className: classes.groupLabel,
      ownerState,
      component: "div",
      children: params.group
    }), /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AutocompleteGroupUl, {
  ...
  const defaultRenderOption = (props2, option) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("li", _extends({}, props2, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(React31.Fragment, {
    children: [/* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AutocompleteRoot, _extends({
      ref,
      className: clsx_m_default(classes.root, className),
      ownerState
    }, getRootProps(other), {
      children: renderInput({
        ...
        InputProps: _extends({
          ...
          endAdornment: /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(AutocompleteEndAdornment, {
            className: classes.endAdornment,
            ownerState,
            children: [hasClearIcon ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AutocompleteClearIndicator, _extends({}, getClearProps(), {
              ...
              children: clearIcon
            })) : null, hasPopupIcon ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AutocompletePopupIndicator, _extends({}, getPopupIndicatorProps(), {
              disabled,
    ...
    })), anchorEl ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AutocompletePopper, _extends({
      as: PopperComponent,
      disablePortal,
      style: {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(AutocompletePaper, _extends({
        ownerState,
        as: PaperComponent
      }, paperSlotProps, {
        className: clsx_m_default(classes.paper, paperSlotProps == null ? void 0 : paperSlotProps.className),
        children: [loading && groupedOptions.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AutocompleteLoading, {
          className: classes.loading,
          ownerState,
          children: loadingText
        }) : null, groupedOptions.length === 0 && !freeSolo && !loading ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AutocompleteNoOptions, {
        ...
        }) : null, groupedOptions.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(AutocompleteListbox, _extends({
          as: ListboxComponent,
...
var Hero = () => {
  ...
  return /* @__PURE__ */ React32.createElement("header", {
  ...
  }, /* @__PURE__ */ React32.createElement(motion.section, {
    variants: {
  ...
  }, /* @__PURE__ */ React32.createElement(AnimatePresence, null, /* @__PURE__ */ React32.createElement("article", {
    className: "lg:max-w-[60%]"
  }, /* @__PURE__ */ React32.createElement(AnimatedLetters, {
    as: "h1",
  ...
  }), /* @__PURE__ */ React32.createElement(AnimatedText, {
    as: "h1",
  ...
  }, /* @__PURE__ */ React32.createElement(Autocomplete_default, {
    open,
    onChange: (_2, b) => {
      setOpen(!open);
      alert(b);
    ...
    options,
    renderInput: (params) => /* @__PURE__ */ React32.createElement("div", {
      ref: params.InputProps.ref,
      style: { width: "100%", marginRight: "50px" }
    }, /* @__PURE__ */ React32.createElement(Input, {
      type: "text",
      ...params.inputProps,
      name: "email",
  ...
  })), /* @__PURE__ */ React32.createElement(MotionLinkButton, {
    to: "#",
    motionProps: {
      variants: {
        hidden: { opacity: 0, y: 50 },
...
var ProjectItem = (0, import_react14.memo)(({ project, ...props }) => {
  ...
  const phoneMotionProps = (0, import_react14.useMemo)(() => ({
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=/build/routes/index-EQGAP3V3.js.map
