      ...
      <section className='relative mt-24 flex grid-cols-12 flex-col-reverse gap-y-10 md:ml-24 md:grid md:gap-x-8 lg:gap-x-16'>
        <section className='col-span-full md:col-span-6 xl:col-span-8'>
          ...
          >
            ...
            <AnimatedText
              as='p'
              text="My name is Alirom Solutions. I am 25 years old, I live in Copenhagen, Denmark, and I'm a self-taught designer and developer."
        ...
        >
          <motion.img
            ...
            alt='Portrait of Alirom Solutions'
            height={400}
            width={400}
          />
        </motion.figure>
